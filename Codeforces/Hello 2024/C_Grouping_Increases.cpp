...
void solve()
{
    ...
    vi temp1={0},temp2={0};
    for(int i=0;i<n;i++){
        if(arr[i]<=temp1.back() && arr[i]<=temp2.back()){
            if(temp2.back()<temp1.back()){
                temp2.pb(arr[i]);
            }
            else{
                temp1.pb(arr[i]);
        ...
        else if(arr[i]<=temp1.back()){
            temp1.pb(arr[i]);
        }
        else if(arr[i]<=temp2.back()){
            temp2.pb(arr[i]);
        }
        else{
            if(temp1.back()==0){
            ...
            else if(temp2.back()==0){
                temp2.pb(arr[i]);
            }
            else if(temp2.back()<temp1.back()){
                temp2.pb(arr[i]);
            }
            else{
                temp1.pb(arr[i]);
